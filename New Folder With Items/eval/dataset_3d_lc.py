...
class UCF101_3d(data.Dataset):
    def __init__(self,
        ...
        # splits
        if mode == 'train':
            split = '/vision/u/ajarno/DPC/UCF101/csvs/train_split%02d.csv' % self.which_split
            video_info = pd.read_csv(split, header=None)
        elif (mode == 'val') or (mode == 'test'):
            split = '/vision/u/ajarno/DPC/UCF101/csvs/test_split%02d.csv' % self.which_split # use test for val, temporary
            video_info = pd.read_csv(split, header=None)
        ...
        action_file = os.path.join('/vision/u/ajarno/DPC/UCF101/splits_classification', 'classInd.txt')
